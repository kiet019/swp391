...
public class ItemController {
    ...
    public ResponseEntity<List<Items>> getItemDynamicFilters(@RequestParam int pageNumber, @RequestParam int pageSize,@ModelAttribute DynamicFilterVM dynamicFilterVM) {
